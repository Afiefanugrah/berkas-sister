...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Berkas Uploads</h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-tanggal_surat">
                                        <th class="title"> Tanggal Berkas: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-Tujuan_surat">
                                        <th class="title"> Tujuan Berkas: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-Nomor_surat">
                                        <th class="title"> Nomor Berkas: </th>
                                        <td class="value">
