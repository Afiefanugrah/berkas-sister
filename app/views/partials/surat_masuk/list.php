                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-Nomor_Surat"> Nomor Berkas</th>
                                                <th  class="td-Tanggal_surat"> Tanggal Berkas</th>
                                                <th  class="td-tanggal_terima"> Tanggal Terima</th>
                                                <th  class="td-Asal_surat"> Asal Berkas</th>
                                                <th  class="td-perihal"> Perihal</th>
                                                <th  class="td-file_surat"> File Berkas</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-No_Agenda"><a href="<?php print_link("surat_masuk/view/$data[No_Agenda]") ?>"><?php echo $data['No_Agenda']; ?></a></td>
                                                    ...
                                                    <td class="td-penerima">
                                                        <span  data-value="<?php echo $data['penerima']; ?>" 
                                                            data-pk="<?php echo $data['No_Agenda'] ?>" 
                                                            data-url="<?php print_link("surat_masuk/editfield/" . urlencode($data['No_Agenda'])); ?>" 
                                                            data-name="penerima" 
